## 3-贯穿Netty的大动脉-ChannelPipeline-1
...
![@TailContext 类层次结构](./tailContext.png)
...
![Alt text](./ChannelInitializer类层次结构图.png)
...
![Alt text](./自定义ChannelHandler分析1.png)
...
![Alt text](./自定义ChannelHandler分析2.png)
